...
|---|---|---|---|
| `maxEmail` | `max@example.com` | Max's personal Google account | `max` |
| `jazEmail` | `jaz@example.com` | Jaz's personal Google account | `jaz` |
| `sharedEmails` | `household@example.com` | shared household account(s), `"; "`-delimited | *shared* (needs actingPerson on write) |
