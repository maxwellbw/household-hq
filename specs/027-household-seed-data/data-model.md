...
- **Anniversaries** (5): literal historical `anchorDate` (e.g. `2020-01-01`) so the ordinal
...
| `monthday-MM-DD` (e.g. `monthday-10-01`, `monthday-XX-XX`) | `nextMonthDayOnOrAfter_(today, MM, DD)` — reuses the existing helper |
