...
var EVENT_SEED_PACK = [
  { seedKey: 'bday-jazmine', title: "Jazmine's birthday", cadence: 'annually', anchorRule: 'monthday-01-02', defaultOwner: 'both', templateId: 'bday-jazmine' },
  { seedKey: 'bday-jaz-mom', title: "Jaz's Mom's birthday", cadence: 'annually', anchorRule: 'monthday-02-17', defaultOwner: 'both', templateId: 'bday-jaz-mom' },
  { seedKey: 'bday-max', title: "Max's birthday", cadence: 'annually', anchorRule: 'monthday-04-12', defaultOwner: 'both', templateId: 'bday-max' },
  { seedKey: 'bday-max-dad', title: "Max's Dad's birthday", cadence: 'annually', anchorRule: 'monthday-06-04', defaultOwner: 'both', templateId: 'bday-max-dad' },
  { seedKey: 'bday-jaz-dad', title: "Jaz's Dad's birthday", cadence: 'annually', anchorRule: 'monthday-06-07', defaultOwner: 'both', templateId: 'bday-jaz-dad' },
  { seedKey: 'bday-uncle-joe', title: "Jaz's Uncle Joe's birthday", cadence: 'annually', anchorRule: 'monthday-06-12', defaultOwner: 'both', templateId: 'bday-uncle-joe' },
  { seedKey: 'bday-wyatt', title: "Wyatt's birthday", cadence: 'annually', anchorRule: 'monthday-07-30', defaultOwner: 'both', templateId: 'bday-wyatt' },
  { seedKey: 'bday-max-mom', title: "Max's Mom's birthday", cadence: 'annually', anchorRule: 'monthday-09-13', defaultOwner: 'both', templateId: 'bday-max-mom' },
  { seedKey: 'anniv-dating', title: '{nth} dating anniversary', cadence: 'annually', anchorDate: '2020-01-24', defaultOwner: 'both' },
  { seedKey: 'anniv-engaged', title: '{nth} engagement anniversary', cadence: 'annually', anchorDate: '2022-05-05', defaultOwner: 'both' },
  { seedKey: 'anniv-married', title: '{nth} wedding anniversary', cadence: 'annually', anchorDate: '2025-05-05', defaultOwner: 'both' },
...
var TEMPLATE_SEED_PACK = [
  { seedKey: 'tmpl-bday-jazmine', eventType: 'bday-jazmine', taskTitle: "Buy Jazmine's birthday gift", offsetDays: -14, defaultOwner: 'max' },
  ...
  { seedKey: 'tmpl-bday-uncle-joe', eventType: 'bday-uncle-joe', taskTitle: 'Text Uncle Joe in the family group chat', offsetDays: 0, defaultOwner: 'both' },
  { seedKey: 'tmpl-bday-wyatt', eventType: 'bday-wyatt', taskTitle: "Buy Wyatt's birthday gift", offsetDays: -7, defaultOwner: 'max' },
