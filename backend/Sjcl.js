/**
 * Vendored crypto (feature 010 -- Web Push requires ECDSA P-256 + ECDH + AES-128-GCM,
 * none of which Apps Script's Utilities class provides; see specs/010-pwa-and-push/
 * research.md R1). This file is SJCL (Stanford JavaScript Crypto Library), MIT/BSD
 * licensed, concatenated verbatim from its own core/ modules -- no logic added,
 * modified, or hand-rolled here.
 *
 * Upstream: https://github.com/bitwiseshiftleft/sjcl
 * Pinned commit: 35b0641709cbefccb0b58b39b2862152a4f4f428
 * Modules included (in dependency order): sjcl.js, bitArray.js, codecBytes.js,
 * codecHex.js, codecBase64.js, codecString.js, sha256.js, hmac.js, bn.js, ecc.js,
 * hkdf.js, gcm.js, aes.js, random.js.
 * Only feature code in WebPush.js calls into this file; nothing else in the
 * backend depends on SJCL directly (Constitution Principle IV exception, plan.md
 * Complexity Tracking).
 *
 * NOTE: random.js's DOM entropy collectors (startCollectors/stopCollectors) are
 * never invoked in this backend -- Apps Script has no window/document. WebPush.js
 * seeds sjcl.random via addEntropy() using Apps Script's own randomness instead.
 */
