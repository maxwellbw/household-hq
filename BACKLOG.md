...
**003 — Tasks CRUD and activity log**, branch `003-tasks-crud-and-activity-log`.
Implemented and deployed (`clasp` @5); `selfTest()` passes `ALL PASS`. Awaiting PR review/merge.
Next step: open the PR, then merge on Max's go-ahead.
