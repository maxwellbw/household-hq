...
|---|---|---|---|---|---|
| 1 | 021 | Someday force-rank + Tasks-tab Someday section | 🟦 deployed (pending validation) | specs/021-someday-force-rank | — |
...
full details directly to `maxandjazmine@gmail.com` (no extra credentials needed —
